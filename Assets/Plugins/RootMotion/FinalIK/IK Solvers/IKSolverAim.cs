...
namespace RootMotion.FinalIK {
	...
	public class IKSolverAim : IKSolverHeuristic {
        ...
        /// 标识 AimTransform 用 AimTransform.forward 还是 AimTransform.up指向 target
        /// 通过迭代的方式将该 骨骼点的上级 下级节点全部盯着 target
        /// </summary>
         ...
         * 最后的 solving 方式就是 根据计算好的限制坐标的坐标进行旋转
		 * */
		private void Solve() {
         ...
         * solving方式：将当前的轴旋转向 target的.关键在于如何 clamp
         * 
         * weight权重是根据 ik权重 * 骨骼权重 * 骨骼
		 * */
