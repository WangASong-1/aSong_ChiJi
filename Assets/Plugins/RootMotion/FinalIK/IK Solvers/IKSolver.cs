...
namespace RootMotion.FinalIK {
	...
	public abstract class IKSolver {
        ...
        /// 通过特殊的root Transform初始化 处理类， 仅仅在 IKSolver 不作为 IK脚本的 成员的时候使用
        /// </summary>
        ...
        /// <summary>
        /// The %IK position.
        /// 目标 position.设置了之后，transformAxis 的上级骨骼全部朝向该点 
        /// IKPosition就是要打击的点
        /// </summary>
        ...
        /// 虚函数必须实现的接口： 子类集成后如何 fix 各自 solver所包含所有的 transform.
        /// 其主要方式就是通过将 position 和 rotation 设置为 初始值的 localposition 和 localRotation
		/// </summary>
