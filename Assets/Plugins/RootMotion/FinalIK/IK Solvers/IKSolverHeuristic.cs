...
namespace RootMotion.FinalIK {
	...
	public class IKSolverHeuristic: IKSolver {
        ...
        /// 最近位置值的公差，如果与先前到达位置的差小于公差，将停止求解.主要用来控制 maxIteration迭代的.当 tolerance == 0,迭代计算到 maxIterations次数.
        /// </summary>
		...
		/// </summary>
		public Bone[] bones = new Bone[0];  //point 序列化了：[System.Serializable]

        /// <summary>
        /// Rebuild the bone hierarcy and reinitiate the solver.
        /// 最新构建骨骼层级 并且 重新初始化 solver
        /// </summary>
        /// <returns>
