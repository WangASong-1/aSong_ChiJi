	...
	public partial class IKSolverVR: IKSolver {
		...
		public class Spine: BodyPart {
			...
			public override void ApplyOffsets() {
				...
				//pelvisDeltaRotation = QuaTools.FromToRotation(pelvis.solverRotation, Quaternion.Lerp(headRotation * pelvisRelativeRotation, IKRotationPelvis, pelvisRotationWeight));
