...
public class WallClimber : MonoBehaviour {
    ...
    private bool b_HorizontalMove = false;
    ...
    #region 检测上升下落的时候的攀爬点(4个点,检测了一个矩形区域) 
    /// <summary>
